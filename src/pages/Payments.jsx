...
const Payments = () => {
    ...
    const fetchPayments = async () => {
        try {
            setLoader(true);
            const res = await axios.get(backendUrl + "/api/admin/doctor-allpayments",
                {
                    params: { cursor, docId },
        ...
        <div className="max-w-3xl mx-auto p-6">
            ...
            <div className="space-y-4">
                {payments.length > 0
                    ...
                    :
                    (
                        !loader && <p className="text-center text-slate-500">No payment history available.</p>
                    )}
            </div>
            {loader && <Loader2 className='w-6 animate-spin mx-auto text-indigo-600' />}
